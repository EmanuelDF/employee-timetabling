from core.evaluateSchedule import EvaluateSchedule
...
if __name__ == '__main__':
    ...
    try:
        ...
        print("---------------------------------------------------------------------------------   Statistics   --------------------------------------------------------------------------------------")
        print('Generated', len(schedules_generated),
              'possibilities in scale order.')
        print('It has been choosen', len(schedules_final),
              'ideal scale.')
